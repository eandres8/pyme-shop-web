# storefront-legacy-redirects

## Purpose

Repoint the application root to the landing page and redirect legacy, unslugged storefront URLs to their slug-scoped equivalents so old links keep working after the `[storeSlug]` restructure.
