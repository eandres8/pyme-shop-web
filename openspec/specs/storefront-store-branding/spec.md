...
Show the active tenant's name in the storefront header brand when a store slug is in context, and fall back to a default brand in global mode or before the tenant name is available.
